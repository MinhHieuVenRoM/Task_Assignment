...
public class AttendanceReportActivity extends AppCompatActivity implements ManagementUserItemClicked {
        ...
        service.getListUser(token)
                .enqueue(new Callback<ListUserModel>() {
                    ...
                    public void onFailure(@NonNull Call<ListUserModel> call, @NonNull Throwable t) {
                        Toast.makeText(AttendanceReportActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public void onItemClickeduser(int position, UserModelDetail model) {
        Toast.makeText(AttendanceReportActivity.this, model.getName(), Toast.LENGTH_SHORT).show();
